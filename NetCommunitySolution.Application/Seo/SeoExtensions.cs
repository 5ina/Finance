...
namespace NetCommunitySolution.Seo
{
    public static class SeoExtensions
    {
        ...
        public static string GetSeName(string name, SeoSetting seoSetting)
        {
            return GetSeName(name, seoSetting.ConvertNonWesternChars, seoSetting.AllowUnicodeCharsInUrls);
        }
        #endregion
        ...
        public static string GetSeName<T>(this T entity, bool returnDefaultValue = true,
            ...
            where T : Entity, ISlugSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");

            string entityName = typeof(T).Name;
            return GetSeName(entity.Id, entityName, returnDefaultValue, ensureTwoPublishedLanguages);
        }
    ...
    bool ensureTwoPublishedLanguages = true)
        ...
        public static string ValidateSeName<T>(this T entity, string seName, string name, bool ensureNotEmpty,SeoSetting seoSetting)
             where T : Entity, ISlugSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");
            ...
            //validation
            seName = GetSeName(seName, seoSetting.ConvertNonWesternChars, seoSetting.AllowUnicodeCharsInUrls);
            ...
            while (true)
            {
                ...
                if (!String.IsNullOrWhiteSpace(seoSetting.ReservedUrlRecordSlugs))
                {
                    var slugsSetting = seoSetting.ReservedUrlRecordSlugs.Split(',');
                    var reserved2 = slugsSetting.Contains(tempSeName, StringComparer.InvariantCultureIgnoreCase);
        ...
        {
            var settingService = Abp.Dependency.IocManager.Instance.Resolve<SettingService>();
            var seoSettings = settingService.GetSeoSetting();
